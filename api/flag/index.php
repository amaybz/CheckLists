...
// set product property values
    $flag->id = $data->id;
    $flag->issue = $data->issue;
    $flag->vehicleID = $data->vehicleID;
    $flag->itemID = $data->itemID;
    $flag->reportedBy = $data->reportedBy;
    $flag->subject = $data->subject;
