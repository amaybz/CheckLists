          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarmenu">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                if($currentPage == 2)
                {
                    echo '<a class="nav-link active" aria-current="page" href="checklist.php">Check Lists</a>';
                }
                else {
                    echo '<a class="nav-link" href="checklist.php">Check Lists</a>';
                }   
                echo '</li>';  
                echo '<li class="nav-item">';
                if($currentPage == 3)
                {
                    echo '<a class="nav-link active" aria-current="page" href="checklistHistory.php">History</a>';
                }
                else {
                    echo '<a class="nav-link" href="checklistHistory.php">History</a>';
                }  
                echo '</li>';                      
               echo '</ul>';
