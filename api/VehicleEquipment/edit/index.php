...
$VehicleEquipment->id = $data->id;
$VehicleEquipment->Name = $data->Name;
$VehicleEquipment->Qty = $data->Qty;
$VehicleEquipment->subCatID = $data->subCatID;
$VehicleEquipment->idVehicleSection = $data->idVehicleSection;
//print_r($data);
...
if($ValidToken == 1){
    ...
    $data = $VehicleEquipment->UpdateEquipment();
    // set response code
    http_response_code(200);
