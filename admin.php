	...
	<body>
		...
		<div class="container">
			<div class="row justify-content-center">
				<p class="text-center">Welcome <?php echo $users->fullName; ?></p>
			</div>
				...
				<?php
					...
					foreach($Vehicles as $Vehicle) {
						...
						echo "<tr><td><a href=adminEquipment.php?idVehicle=" . $Vehicle['id'] . ">" . $Vehicle['Name'] . "</a></td><td> " . $Vehicle['CallSign'] . "</td>"  ;
